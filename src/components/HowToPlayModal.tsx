    ...
    <Modal isOpen={isOpen} onClose={onClose} title="How to Play?" className="how-to-play-modal">
      ...
      <div className="how-to-play-content">
        <section className="how-to-play-section">
          ...
          <p>
            ECC Game is a fun way to learn about <strong>Elliptic Curve Cryptography (ECC)</strong>{' '}
            - the mathematics behind Bitcoin and cryptocurrency security.
          </p>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Multiplication:</strong> Adding a point to itself multiple times (scalar
                    multiplication)
                  </li>
                  <li>
        ...
        <section className="how-to-play-section">
          ...
          <div className="calculator-guide">
            <p>
              The calculator operates on the <strong>current point</strong> shown on the graph. You
              perform point operations to move from it to another point to reveal the private key
              for the goal wallet. Starting from G or the Goal, make repeated operations until you
              reveal the private key by creating a sequence of operations that connects the two
              points.
            </p>
            ...
            <div className="calc-operations">
              ...
              <ul>
                ...
                <li>
                  <strong>rand:</strong> Generate a random number between 2 and the curve order for
            ...
            <div className="calc-workflow">
              ...
              <h4>Save Points:</h4>
              <p>
                <strong>Click the star</strong> to save a point to the graph so you can use it as a
                reference to jump back to. Click the star again to unsave.
              </p>
            </div>
          </div>
        </section>
